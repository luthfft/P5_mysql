    ...
    <table id="example" class="display" style="width:90%">
      ...
      <tbody>
        ...
        while ($jenis = mysqli_fetch_array($query)) {
          ...
          echo "<td>";
          echo "<a href='editjenis.php?id=" . $jenis['id_jenis_buku'] . "'><button class='btn btn-warning'>Edit</button></a> <a href='hapusjenis.php?id=" . $jenis['id_jenis_buku'] . "'><button class='btn btn-danger'>Delete</button></a>";
          "</td>";
          echo "</tr>";
        }
        ?>
