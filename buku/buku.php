...
<body>
  ...
  <div class="a">
    ...
    ?>
    <a href="createbuku.php"><button type="button" class="btn btn-success" style="margin-bottom: 20px;">Add Data</button></a>
      ...
      <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $stok . "</td>";
            echo "<td>";
            echo "<a href='editbuku.php?id=" . $id . "'><button class='btn btn-warning'>Edit</button></a> <a href='hapusbuku.php?id=" . $id . "'><button class='btn btn-danger'>Delete</button></a>";
            "</td>";
            echo "</tr>";
          }
        }
